...
(function () {
  ...
  function paintScript() {
    ...
    var out = ["#!/bin/sh", "# Generated by the sandbox. Each line is the real command",
      "# for the change made above, in the order you made it.", ""];
    var last = null;
  ...
  function paintPackets() {
    ...
    log.forEach(function (e) {
      ...
      html += '<div class="sb-pkt is-' + cls + '">' +
        ...
        '<span class="pk-rung">rung ' + e.rung + "/5</span></div>" +
  ...
  /* ============================================================
     10 · URL state, so a configuration can be shared
     ============================================================ */
